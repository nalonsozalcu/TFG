			...
			<table class="table" style="width:100%">
				...
				<?php
					...
					foreach ($eventos as $i => $value):?>
						...
						<td><?php echo($eventos[$i]["horario"])?></td>
						<td><?php echo($eventos[$i]["transporte"])?></td>
						<td><?php echo($eventos[$i]["url"])?></td>
						<td><?php echo($eventos[$i]["direccion"])?></td>
						<td><?php echo($eventos[$i]["telefono"])?></td>
						<td><?php echo($eventos[$i]["email"])?></td>
