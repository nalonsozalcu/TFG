					...
					if($i < count($restaurante)):
						...
						<div class="col-4">
							<div class="card h-100">
								<div class="card-body">
									<h5><i class='fa-regular fa-calendar-check'></i><a href="actividadPage.php?content=restaurante&id=<?php echo($restaurante[$i]["id"]) ?>" class="ms-3 card-link" style="text-decoration:none"><?php echo($restaurante[$i]["nombre"])?></a></h5>
